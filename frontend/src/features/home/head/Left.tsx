...
export const Left = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-start h-screen gap-4 px-10 max-xl:px-0 w-1/2 max-xl:w-3/4 text-chart-1">
            ...
            <p className="text-xl max-sm:text-sm">Plan, track, and manage any project in one flexible workspace. Tasks, docs, timelines, and AI that already understands your work, all built in from day one.</p>

            <button
                onClick={fetchUser}
                className="text-2xl max-sm:text-lg text-card rounded-2xl bg-chart-1 mt-3 py-4 px-8 max-sm:px-5 max-sm:py-2 hover:bg-muted hover:text-chart-1 transition-all duration-[0.5s] ease-[ease-in-out] drop-shadow-2xl"
            >
